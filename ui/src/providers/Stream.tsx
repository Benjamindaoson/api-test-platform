...
const API_KEY_AUTH_SCHEME = "langsmith-api-key";
        ...
        <div className="animate-in fade-in-0 zoom-in-95 bg-background flex max-w-3xl flex-col rounded-lg border shadow-lg">
          ...
          <form
            onSubmit={(e) => {
              ...
              setAuthScheme(isAgentBuilder ? API_KEY_AUTH_SCHEME : "");
          ...
          >
            <div className="flex flex-col gap-2">
              ...
              <p className="text-muted-foreground text-sm">
                This is the URL of your agent deployment. Can be a local, or
            ...
            <div className="flex flex-col gap-2">
              ...
              <p className="text-muted-foreground text-sm">
                This is <strong>NOT</strong> required if using a local agent
                server. This value is stored in your browser's local storage and
                is only used to authenticate requests sent to your agent
                server.
              </p>
              <PasswordInput
                id="apiKey"
              ...
              <div className="flex items-center justify-between gap-4">
                <div className="flex flex-col gap-1">
                  <Label htmlFor="agentBuilderEnabled">
                    Use API key auth scheme
                  </Label>
                  <p className="text-muted-foreground text-sm">
                    Enable this for deployments that require an API key auth
                    scheme.
                  </p>
                </div>
                <Switch
